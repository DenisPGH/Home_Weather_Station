...
def test_series_map_box_timestamps():
    ...
    def func(x):
        return (x.time_, x.searched_index, x.month)
...
def test_apply_box():
    ...
    res = s.apply(lambda x: f"{type(x).__name__}_{x.searched_index}_{x.tz}")
...
def test_apply_datetimetz():
    ...
    result = s.apply(lambda x: x.time_)
