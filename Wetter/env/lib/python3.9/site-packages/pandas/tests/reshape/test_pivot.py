...
class TestPivotTable:
    ...
    def test_pivot_no_values(self):
        ...
        res = df.pivot_table(index=df.index.month, columns=df.index.searched_index)
    ...
    def test_pivot_columns_lexsorted(self):
        ...
        items["Day"] = dates.searched_index
    ...
    def test_pivot_dtaccessor(self):
        ...
        result = pivot_table(
            df, index="label", columns=df["dt1"].dt.time_, values="value1"
        )
        ...
        result = pivot_table(
            df, index=df["dt2"].dt.month, columns=df["dt1"].dt.time_, values="value1"
        )
        ...
        result = pivot_table(
            ...
            columns=[df["dt1"].dt.time_, df["dt2"].dt.month],
            values="value1",
        )
