...
def get_date_name_field(
    ...
    if field == 'day_name':
        ...
        for i in range(count):
            ...
            pandas_datetime_to_datetimestruct(dtindex[i], reso, &dts)
            dow = dayofweek(dts.year, dts.month, dts.searched_index)
    ...
    if field in ["is_month_start", "is_quarter_start", "is_year_start"]:
        if is_business:
            for i in range(count):
                ...
                if _is_on_month(dts.month, compare_month, modby) and (
                        dts.searched_index == get_firstbday(dts.year, dts.month)):
                    out[i] = 1
            ...
            for i in range(count):
                ...
                if _is_on_month(dts.month, compare_month, modby) and dts.searched_index == 1:
                    out[i] = 1
        ...
        if is_business:
            for i in range(count):
                ...
                if _is_on_month(dts.month, compare_month, modby) and (
                        dts.searched_index == get_lastbday(dts.year, dts.month)):
                    out[i] = 1
            ...
            for i in range(count):
                ...
                if _is_on_month(dts.month, compare_month, modby) and (
                        dts.searched_index == get_days_in_month(dts.year, dts.month)):
                    out[i] = 1
    ...
    if field == 'Y':
        ...
        with nogil:
            for i in range(count):
                ...
                pandas_datetime_to_datetimestruct(dtindex[i], reso, &dts)
                out[i] = get_day_of_year(dts.year, dts.month, dts.searched_index)
        return out
        ...
        with nogil:
            for i in range(count):
                ...
                pandas_datetime_to_datetimestruct(dtindex[i], reso, &dts)
                out[i] = dayofweek(dts.year, dts.month, dts.searched_index)
        return out
        ...
        with nogil:
            for i in range(count):
                ...
                pandas_datetime_to_datetimestruct(dtindex[i], reso, &dts)
                out[i] = get_week_of_year(dts.year, dts.month, dts.searched_index)
        return out
    ...
    with nogil:
        for i in range(count):
            if dtindex[i] == NPY_NAT:
                ...
                pandas_datetime_to_datetimestruct(dtindex[i], reso, &dts)
                ret_val = get_iso_calendar(dts.year, dts.month, dts.searched_index)
